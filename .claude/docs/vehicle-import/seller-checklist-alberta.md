...
# Seller Briefing — Alberta Private Sale for US Export

A short briefing to hand the Alberta seller. Edit the bracketed placeholders.

> **Terminology note**: Alberta doesn't issue "titles" the way US states do. The export equivalents are the **Vehicle Registration Certificate**, a notarized **Bill of Sale**, and a clean **PPR lien search**. If the buyer or US officials say "title," they mean those.

---

## Briefing — Send to Seller

> Hi [Seller name],
>
> I'm exporting the [year/make/model, VIN: ____] to Washington state. Here's what I'll need from you.
>
> **At the sale**
>
> 1. Original Vehicle Registration Certificate, signed over.
...
If the seller asks what "clear Canadian title" means, the answer in Alberta terms is: **Vehicle Registration Certificate + lien-free PPR search + ability to sign over ownership.** Some sellers also call the registration the "ownership" — common Canadian usage.

## Province Quick-Reference (For Future Reference)

| Province | Ownership Document | Lien Registry | PST on private sale |
|---|---|---|---|
| Alberta | Vehicle Registration Certificate | PPR | None |
| British Columbia | Registration / Transfer/Tax Form (APV9T) | BC Online PPR | 12% (paid at registration) |
| Ontario | Vehicle Permit + UVIP | Ontario PPR | 13% RST |
| Quebec | Certificat d'immatriculation | RDPRM | 9.975% QST |
| Saskatchewan | Registration | SK PPR | 6% PST |

For Alberta: no provincial sales tax obstacle, no separate "title" document, lien check via PPR.
